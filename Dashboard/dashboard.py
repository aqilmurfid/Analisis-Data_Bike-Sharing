...
def create_rfm_df(df):
    ...
    return rfm_df
# Prepare dataframe
day_df = pd.read_csv("E:\Dicoding\Hasil Analisis.csv")
...
# Diagram pie chart untuk "By Frequency"
freq_data = rfm_df.sort_values(by="frequency", ascending=False).head(5)
ax[1].pie(freq_data["frequency"], labels=freq_data["day"], autopct='%1.1f%%', startangle=90, colors=colors)
...
st.caption(f"Copyright © 2023 All Rights Reserved Murfid Aqil (https://www.linkedin.com/in/murfidaqil/)")
